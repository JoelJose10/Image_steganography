...
# Example usage
base_image_path = r"C:\Users\joelj\OneDrive\Desktop\Image stegnography\base image\256x256-png-images-8.png"  # Replace with your base image path
secret_image_path = r"C:\Users\joelj\OneDrive\Desktop\Image stegnography\secret image\R.png"  # Replace with your secret image path
encoded_image_path = "encoded_image_with_secret.png"  # Output path for encoded image
decoded_image_path = "decoded_hidden_image.png"  # Output path for decoded image
